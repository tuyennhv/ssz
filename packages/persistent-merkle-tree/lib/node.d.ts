...
export declare type HashComputationGroup = {
...
export declare function getHashComputations(node: Node, offset: number, hashCompsByLevel: Array<HashComputation[]>): void;
export declare function executeHashComputations(hashComputations: Array<HashComputation[]>): void;
export declare function arrayAtIndex<T>(twoDArray: Array<T[]>, index: number): T[];
