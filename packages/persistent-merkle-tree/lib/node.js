...
exports.arrayAtIndex = exports.executeHashComputations = exports.getHashComputations = exports.bitwiseOrNodeH = exports.setNodeH = exports.getNodeH = exports.compose = exports.identity = exports.LeafNode = exports.BranchNode = exports.Node = void 0;
...
function getHashComputations(node, offset, hashCompsByLevel) {
    if (node.h0 === null) {
...
function executeHashComputations(hashComputations) {
    hasher_1.hasher.executeHashComputations(hashComputations);
}
exports.executeHashComputations = executeHashComputations;
function arrayAtIndex(twoDArray, index) {
    if (twoDArray[index] === undefined) {
        twoDArray[index] = [];
    }
    return twoDArray[index];
}
exports.arrayAtIndex = arrayAtIndex;
