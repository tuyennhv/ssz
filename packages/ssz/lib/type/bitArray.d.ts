import { Gindex, HashComputationGroup, Node, Tree } from "@chainsafe/persistent-merkle-tree";
...
export declare abstract class BitArrayType extends CompositeType<BitArray, BitArrayTreeView, BitArrayTreeViewDU> {
    ...
    commitViewDU(view: BitArrayTreeViewDU, hashComps?: HashComputationGroup | null): Node;
