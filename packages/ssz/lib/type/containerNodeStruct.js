...
class ContainerNodeStructType extends container_1.ContainerType {
    constructor(fields, opts) {
        ...
        this.temporaryRoot = new Uint8Array(32);
    ...
    tree_deserializeFromBytes(data, start, end) {
        ...
        return new branchNodeStruct_1.BranchNodeStruct(this.valueToTree.bind(this), this.computeRootInto.bind(this), value);
    }
    // Proofs
    ...
    tree_fromProofNode(node) {
        ...
        return {
            node: new branchNodeStruct_1.BranchNodeStruct(this.valueToTree.bind(this), this.computeRootInto.bind(this), value),
            done: true,
        };
    }
    ...
    computeRootInto(value, node) {
        if (node.h0 !== null) {
            return;
        }
        this.hashTreeRootInto(value, this.temporaryRoot, 0);
        as_sha256_1.byteArrayIntoHashObject(this.temporaryRoot, 0, node);
    }
}
