...
class ArrayCompositeTreeViewDU extends abstract_1.TreeViewDU {
    ...
    commit(hashComps = null) {
        ...
        const hashCompsView = hashComps != null && isOldRootHashed
            ? {
        ...
        const hashCompsThis = hashComps != null && isOldRootHashed
            ? {
                byLevel: hashComps.byLevel,
                offset: hashComps.offset + this.type.tree_chunksNodeOffset(),
            }
            : null;
        const newChunksNode = persistent_merkle_tree_1.setNodesAtDepth(chunksNode, this.type.chunkDepth, indexes, nodes, hashCompsThis);
        this._rootNode = this.type.tree_setChunksNode(this._rootNode, newChunksNode, this.dirtyLength ? this._length : null, hashComps);
        if (!isOldRootHashed && hashComps !== null) {
            persistent_merkle_tree_1.getHashComputations(this._rootNode, hashComps.offset, hashComps.byLevel);
        }
